...
def conver_lb_config(args):
    ...
    alb_config = nsxt_config_converter.convert(args.nsxt_ip, args.nsxt_user, args.nsxt_passord, args.nsxt_port,
...
def upload_config_to_controller(alb_config, args):
    avi_rest_lib.upload_config_to_controller(alb_config, args.controller_ip, args.user, args.password, args.tenant)
