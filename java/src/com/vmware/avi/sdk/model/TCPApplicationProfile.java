...
public class TCPApplicationProfile  {
     ...
     * Allowed in enterprise with any value edition, essentials(allowed values- proxy_protocol_version_1) edition, basic(allowed values-
     * proxy_protocol_version_1) edition, enterprise with cloud services edition.
     ...
     * Field introduced in 18.2.3.
     * Allowed in enterprise with any value edition, essentials(allowed values- ssl_client_certificate_none) edition, basic(allowed values-
     * ssl_client_certificate_none) edition, enterprise with cloud services edition.
