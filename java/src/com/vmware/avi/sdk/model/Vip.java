...
public class Vip  {
     ...
     * Allowed in enterprise with any value edition, essentials(allowed values- v4_only) edition, basic(allowed values- v4_only) edition, enterprise
     ...
     * Allowed in enterprise with any value edition, essentials(allowed values- 32) edition, basic(allowed values- 32) edition, enterprise with cloud
     * services edition.
