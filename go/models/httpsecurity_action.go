...
type HttpsecurityAction struct {
	...
	// Type of the security action to perform. Enum options - HTTP_SECURITY_ACTION_CLOSE_CONN, HTTP_SECURITY_ACTION_SEND_RESPONSE, HTTP_SECURITY_ACTION_ALLOW, HTTP_SECURITY_ACTION_REDIRECT_TO_HTTPS, HTTP_SECURITY_ACTION_RATE_LIMIT, HTTP_SECURITY_ACTION_REQUEST_CHECK_ICAP. Allowed in Enterprise with any value edition, Essentials(Allowed values- HTTP_SECURITY_ACTION_CLOSE_CONN,HTTP_SECURITY_ACTION_SEND_RESPONSE,HTTP_SECURITY_ACTION_REDIRECT_TO_HTTPS) edition, Basic(Allowed values- HTTP_SECURITY_ACTION_CLOSE_CONN,HTTP_SECURITY_ACTION_SEND_RESPONSE,HTTP_SECURITY_ACTION_REDIRECT_TO_HTTPS) edition, Enterprise with Cloud Services edition.
	// Required: true
	Action *string `json:"action"`

	// File to be used for generating HTTP local response. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	File *HTTPLocalFile `json:"file,omitempty"`

	// Secure SSL/TLS port to redirect the HTTP request to. Allowed values are 1-65535. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	HTTPSPort *int32 `json:"https_port,omitempty"`

	// Rate Limit profile to be used to rate-limit the flow.  (deprecated). Field deprecated in 18.2.9. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	RateLimit *RateProfile `json:"rate_limit,omitempty"`

	// Rate limiting configuration for this action. Field introduced in 18.2.9. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
