...
type BackupConfiguration struct {
	...
	// The name of the AWS region associated with the bucket. Field introduced in 21.1.5. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
