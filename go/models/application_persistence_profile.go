...
type ApplicationPersistenceProfile struct {
	...
	// Specifies the Application Cookie Persistence profile parameters. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Specifies the custom HTTP Header Persistence profile parameters. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	HdrPersistenceProfile *HdrPersistenceProfile `json:"hdr_persistence_profile,omitempty"`

	// Specifies the HTTP Cookie Persistence profile parameters. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	HTTPCookiePersistenceProfile *HTTPCookiePersistenceProfile `json:"http_cookie_persistence_profile,omitempty"`

	// Specifies the Client IP Persistence profile parameters. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// A user-friendly name for the persistence profile. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	// Required: true
	...
	// UUID of the persistence profile. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
