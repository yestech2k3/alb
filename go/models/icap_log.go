...
type IcapLog struct {
	...
	// Logs for the HTTP request's content sent to the ICAP server. Field introduced in 20.1.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
