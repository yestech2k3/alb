...
type HealthMonitorTCP struct {
	...
	// Request data to send after completing the TCP handshake. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	TCPRequest *string `json:"tcp_request,omitempty"`

	// Match for the desired keyword in the first 2Kb of the server's TCP response. If this field is left blank, no server response is required. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
