...
type HealthMonitor struct {
	...
	// Authentication information for username/password. Field introduced in 20.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Number of continuous failed health checks before the server is marked down. Allowed values are 1-50. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	FailedChecks *int32 `json:"failed_checks,omitempty"`

	// Health monitor for FTP. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	FtpMonitor *HealthMonitorFtp `json:"ftp_monitor,omitempty"`

	// Health monitor for FTPS. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Health monitor for IMAP. Field introduced in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	ImapMonitor *HealthMonitorImap `json:"imap_monitor,omitempty"`

	// Health monitor for IMAPS. Field introduced in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Health monitor for LDAP. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	LdapMonitor *HealthMonitorLdap `json:"ldap_monitor,omitempty"`

	// Health monitor for LDAPS. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// A user friendly name for this health monitor. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	// Required: true
	Name *string `json:"name"`

	// Health monitor for POP3. Field introduced in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	Pop3Monitor *HealthMonitorPop3 `json:"pop3_monitor,omitempty"`

	// Health monitor for POP3S. Field introduced in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	Pop3sMonitor *HealthMonitorPop3 `json:"pop3s_monitor,omitempty"`

	// Health monitor for Radius. Field introduced in 18.2.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Frequency, in seconds, that monitors are sent to a server. Allowed values are 1-3600. Unit is SEC. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	SendInterval *int32 `json:"send_interval,omitempty"`

	// Health monitor for SIP. Field introduced in 17.2.8, 18.1.3, 18.2.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	SipMonitor *HealthMonitorSIP `json:"sip_monitor,omitempty"`

	// Health monitor for SMTP. Field introduced in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	SMTPMonitor *HealthMonitorSMTP `json:"smtp_monitor,omitempty"`

	// Health monitor for SMTPS. Field introduced in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	SmtpsMonitor *HealthMonitorSMTP `json:"smtps_monitor,omitempty"`

	// Number of continuous successful health checks before server is marked up. Allowed values are 1-50. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// UUID of the health monitor. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
