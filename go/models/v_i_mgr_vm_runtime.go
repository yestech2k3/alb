...
type VIMgrVMRuntime struct {
	...
	//  Field introduced in 17.1.1,17.1.3. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
