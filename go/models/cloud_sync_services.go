...
type CloudSyncServices struct {
	...
	// List of vips. Field introduced in 18.2.2. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
