...
type ClusterCloudDetails struct {
	...
	// Azure info to configure cluster_vip on the controller. Field introduced in 17.2.5. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	//  It is a reference to an object of type Tenant. Field introduced in 17.2.5. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
