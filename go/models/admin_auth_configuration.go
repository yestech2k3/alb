...
type AdminAuthConfiguration struct {
	...
	// Secondary authentication mechanisms to be used. Field introduced in 20.1.6. Maximum of 1 items allowed. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
	AlternateAuthConfigurations []*AlternateAuthConfiguration `json:"alternate_auth_configurations,omitempty"`

	//  It is a reference to an object of type AuthProfile. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	AuthProfileRef *string `json:"auth_profile_ref,omitempty"`

	// Rules list for tenant or role mapping. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
