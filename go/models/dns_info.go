...
type DNSInfo struct {
	...
	// Canonical name in CNAME record. Field introduced in 17.2.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	Cname *DNSCnameRdata `json:"cname,omitempty"`

	// Fully qualified domain name. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	Fqdn *string `json:"fqdn,omitempty"`

	// Any metadata associated with this record. Field introduced in 17.2.2. Allowed in Enterprise with any value edition, Essentials with any value edition, Basic with any value edition, Enterprise with Cloud Services edition.
	// Read Only: true
	...
	// Time to live for fqdn record. Default value is chosen from DNS profile for this cloud if no value provided. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
