...
type ConfigUpdateDetails struct {
	...
	// New updated data of the resource. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	NewResourceData *string `json:"new_resource_data,omitempty"`

	// Old & overwritten data of the resource. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Config type of the updated resource. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
