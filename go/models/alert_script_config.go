...
type AlertScriptConfig struct {
	...
	// User Defined Alert Action Script. Please refer to kb.avinetworks.com for more information. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// A user-friendly name of the Script. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	// Required: true
