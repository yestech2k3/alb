...
type SeMgrEventDetails struct {
	...
	//  Field introduced in 20.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// vSphere HA on cluster enabled. Field introduced in 20.1.7, 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
