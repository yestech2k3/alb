...
type AuthMappingProfile struct {
	...
	// Description for the tenant of AuthMappingProfile. It is a reference to an object of type Tenant. Field introduced in 22.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
