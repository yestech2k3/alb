...
type HostHdrMatch struct {
	...
	// String value(s) in the host header. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
