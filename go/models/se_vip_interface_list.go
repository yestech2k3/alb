...
type SeVipInterfaceList struct {
	...
	// List of placement_networks reachable from this interface. Field introduced in 20.1.5. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
