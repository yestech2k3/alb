...
type SnmpTrapProfile struct {
	...
	// A user-friendly name of the SNMP trap configuration. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	// Required: true
	...
	// The IP address or hostname of the SNMP trap destination server. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// UUID of the SNMP trap profile object. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
