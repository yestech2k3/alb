...
type Permission struct {
	...
	// Limits the scope of Write Access on the parent resource to modification of only the specified subresources. Field introduced in 20.1.5. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
