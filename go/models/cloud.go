...
type Cloud struct {
	...
	//  Field deprecated in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	ApicConfiguration *APICConfiguration `json:"apic_configuration,omitempty"`

	//  Field deprecated in 21.1.1. Allowed in Enterprise with any value edition, Essentials(Allowed values- false) edition, Basic(Allowed values- false) edition, Enterprise with Cloud Services edition.
	...
	//  Field introduced in 17.2.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Custom tags for all Avi created resources in the cloud infrastructure. Field introduced in 17.1.5. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	CustomTags []*CustomTag `json:"custom_tags,omitempty"`

	// Select the IP address management scheme. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	DhcpEnabled *bool `json:"dhcp_enabled,omitempty"`

	// DNS Profile for the cloud. It is a reference to an object of type IpamDnsProviderProfile. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// DNS resolver for the cloud. Field introduced in 20.1.5. Maximum of 1 items allowed. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// DNS Profile for East-West services. It is a reference to an object of type IpamDnsProviderProfile. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Enable VIP on all data interfaces for the Cloud. Field introduced in 18.2.9, 20.1.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	EnableVipOnAllInterfaces *bool `json:"enable_vip_on_all_interfaces,omitempty"`

	// Use static routes for VIP side network resolution during VirtualService placement. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	EnableVipStaticRoutes *bool `json:"enable_vip_static_routes,omitempty"`

	// Google Cloud Platform Configuration. Field introduced in 18.2.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	GcpConfiguration *GCPConfiguration `json:"gcp_configuration,omitempty"`

	// Enable IPv6 auto configuration. Field introduced in 18.1.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	Ip6AutocfgEnabled *bool `json:"ip6_autocfg_enabled,omitempty"`

	// Ipam Profile for the cloud. It is a reference to an object of type IpamDnsProviderProfile. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Cloud is in maintenance mode. Field introduced in 20.1.7,21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	MaintenanceMode *bool `json:"maintenance_mode,omitempty"`

	// List of labels to be used for granular RBAC. Field introduced in 22.1.1. Allowed in Enterprise with any value edition, Essentials with any value edition, Basic with any value edition, Enterprise with Cloud Services edition.
	Markers []*RoleFilterMatchLabel `json:"markers,omitempty"`

	//  Field deprecated in 18.2.2. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	MesosConfiguration *MesosConfiguration `json:"mesos_configuration,omitempty"`

	// MTU setting for the cloud. Unit is BYTES. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Configuration parameters for NSX Manager. Field deprecated in 21.1.1. Field introduced in 17.1.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	NsxConfiguration *NsxConfiguration `json:"nsx_configuration,omitempty"`

	// NSX-T Cloud Platform Configuration. Field introduced in 20.1.1. Allowed in Enterprise with any value edition, Basic edition, Enterprise with Cloud Services edition.
	NsxtConfiguration *NsxtConfiguration `json:"nsxt_configuration,omitempty"`

	// Default prefix for all automatically created objects in this cloud. This prefix can be overridden by the SE-Group template. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Prefer static routes over interface routes during VirtualService placement. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// The Service Engine Group to use as template. It is a reference to an object of type ServiceEngineGroup. Field introduced in 18.2.5. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	SeGroupTemplateRef *string `json:"se_group_template_ref,omitempty"`

	// DNS records for VIPs are added/deleted based on the operational state of the VIPs. Field introduced in 17.1.12. Allowed in Enterprise with any value edition, Essentials(Allowed values- true) edition, Basic(Allowed values- true) edition, Enterprise with Cloud Services edition.
	...
	// This deployment is VMware on AWS cloud. Field introduced in 20.1.5, 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
