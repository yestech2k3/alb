...
type WafLog struct {
	...
	// Set to true if Application Specific Signature rules were executed. Field deprecated in 20.1.3. Field introduced in 20.1.1. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Set to true if Positive Security Model rules were executed. Field deprecated in 20.1.3. Field introduced in 18.2.3. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Set to true if ModSecurity rules were executed. Field deprecated in 20.1.3. Field introduced in 18.2.3. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Set to true if there are whitelist rules in the policy. Field deprecated in 20.1.3. Field introduced in 18.2.3. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	WhitelistConfigured *bool `json:"whitelist_configured,omitempty"`

	// Set to true if whitelist rules were executed. Field deprecated in 20.1.3. Field introduced in 18.2.3. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	WhitelistExecuted *bool `json:"whitelist_executed,omitempty"`

	// Log Entries generated by WAF whitelist rules. Field deprecated in 20.1.3. Field introduced in 18.2.3. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
