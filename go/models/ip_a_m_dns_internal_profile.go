...
type IPAMDNSInternalProfile struct {
	...
	// Use usable_networks. It is a reference to an object of type Network. Field deprecated in 20.1.3. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
