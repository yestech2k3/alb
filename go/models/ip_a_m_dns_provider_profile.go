...
type IPAMDNSProviderProfile struct {
	...
	// If this flag is set, only allocate IP from networks in the Virtual Service VRF. Applicable for Avi Vantage IPAM only. Field introduced in 17.2.4. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	AllocateIPInVrf *bool `json:"allocate_ip_in_vrf,omitempty"`

	// Provider details if type is AWS. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	AwsProfile *IPAMDNSAwsProfile `json:"aws_profile,omitempty"`

	// Provider details if type is Microsoft Azure. Field introduced in 17.2.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Provider details if type is Custom. Field introduced in 17.1.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	CustomProfile *IPAMDNSCustomProfile `json:"custom_profile,omitempty"`

	// Provider details if type is Google Cloud. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	GcpProfile *IPAMDNSGCPProfile `json:"gcp_profile,omitempty"`

	// Provider details if type is Infoblox. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	InfobloxProfile *IPAMDNSInfobloxProfile `json:"infoblox_profile,omitempty"`

	// Provider details if type is Avi. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Name for the IPAM/DNS Provider profile. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	// Required: true
	Name *string `json:"name"`

	// Provider details for Oracle Cloud. Field introduced in 18.2.1,18.1.3. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	OciProfile *IPAMDNSOCIprofile `json:"oci_profile,omitempty"`

	// Provider details if type is OpenStack. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Provider details for Tencent Cloud. Field introduced in 18.2.3. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// UUID of the IPAM/DNS Provider profile. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
