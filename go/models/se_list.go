...
type SeList struct {
	...
	// Indicates if an SE is at the current version. This state will now be derived from SE Group runtime. Field deprecated in 18.1.5, 18.2.1. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// This field indicates the status of programming network reachability to the Virtual Service IP in the cloud. Field deprecated in 21.1.3. Field introduced in 17.2.3. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	AttachIPStatus *string `json:"attach_ip_status,omitempty"`

	// This flag indicates if network reachability to the Virtual Service IP in the cloud has been successfully programmed. Field deprecated in 21.1.3. Field introduced in 17.2.3. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// This field is not needed with the current implementation of Update RPCs to SEs. Field deprecated in 18.1.5, 18.2.1. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// This flag indicates whether the geo-files have been pushed to the DNS-VS's SE. No longer used, replaced by SE DataStore. Field deprecated in 18.1.5, 18.2.1. Field introduced in 17.1.1. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	GeoDownload *bool `json:"geo_download,omitempty"`

	// This flag indicates whether the geodb object has been pushed to the DNS-VS's SE. No longer used, replaced by SE DataStore. Field deprecated in 18.1.5, 18.2.1. Field introduced in 17.1.2. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	GeodbDownload *bool `json:"geodb_download,omitempty"`

	// This flag indicates whether the gslb, ghm, gs objects have been pushed to the DNS-VS's SE. No longer used, replaced by SE DataStore. Field deprecated in 18.1.5, 18.2.1. Field introduced in 17.1.1. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// This flag was used to display the SE connected state. This state will now be derived from SE Group runtime. Field deprecated in 18.1.5, 18.2.1. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// SE scaling in status is determined by delete_in_progress. Field deprecated in 18.1.5, 18.2.1. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
	...
	// Version of the SE. This state will now be derived from SE Group runtime. Field deprecated in 18.1.5, 18.2.1. Allowed in Enterprise edition with any value, Essentials, Basic, Enterprise with Cloud Services edition.
