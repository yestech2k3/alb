...
type AzureNetworkInfo struct {
	...
	// Id of the Azure subnet where Avi Controller will create the Service Engines. . Field introduced in 17.2.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	SeNetworkID *string `json:"se_network_id,omitempty"`

	// Virtual network where Virtual IPs will belong. Field introduced in 17.2.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
