...
type ScheduledScaling struct {
	...
	// Desired number of servers during Schedule intervals, it may cause scale-in or scale-out based on the value. Field introduced in 21.1.1.
	DesiredCapacity *int32 `json:"desired_capacity,omitempty"`

	// Enables the scheduled autoscaling. Field introduced in 21.1.1.
	Enable *bool `json:"enable,omitempty"`

	// Scheduled autoscale end date in ISO8601 format, said day will be included in schedule and have to be in future and greater than start date. Field introduced in 21.1.1.
	EndDate *string `json:"end_date,omitempty"`

	// Frequency of the Scheduled autoscale. Enum options - ONCE, EVERY_DAY, EVERY_WEEK, EVERY_MONTH. Field introduced in 21.1.1.
	// Required: true
	...
	// Scheduled autoscale start date in ISO8601 format, said day will be included in schedule and have to be in future. Field introduced in 21.1.1.
