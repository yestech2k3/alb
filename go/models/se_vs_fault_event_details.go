...
type SeVsFaultEventDetails struct {
	...
	// Name of the object responsible for the fault. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	FaultObject *string `json:"fault_object,omitempty"`

	// Reason for the fault. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
