...
type VIMgrSEVMRuntime struct {
	...
	// ServiceEngine deployed on cluster.Ex MOB  domain-c23. Field introduced in 20.1.7.
	ClusterID *string `json:"cluster_id,omitempty"`

	// ServiceEngine added to cluster vmgroup. Field introduced in 20.1.7.
	...
	// ServiceEngine host connection state in vCenter. Field introduced in 20.1.7.
	VcenterHostConnectionState *string `json:"vcenter_host_connection_state,omitempty"`

	// VCenter Host HA state.Ex  election, fdmUnreachable, hostDown, initializationError, networkIsolated, uninitializationError, uninitialized. Field introduced in 20.1.7.
	...
	// VSphere HA on cluster enabled or not. Field introduced in 20.1.7.
	VsphereHaEnabled *bool `json:"vsphere_ha_enabled,omitempty"`

	// If this flag is set to True, vCenter vSphere HA handles ServiceEngine failure. This flag is set dynamiclly based on underlying ESX HA state(connected, hostDown..etc). Field introduced in 20.1.7.
