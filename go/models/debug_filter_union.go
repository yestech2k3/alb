...
type DebugFilterUnion struct {
	...
	// Add filter to Log Manager Debug. Field introduced in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Add Metricsapi Server filter. Field introduced in 18.2.3. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Add SE RPC Proxy Filter. Field introduced in 18.1.5, 18.2.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	SeRPCProxyFilter *SeRPCProxyDebugFilter `json:"se_rpc_proxy_filter,omitempty"`

	// Add Metricsapi Server filter. Field introduced in 18.2.6. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
