...
type HTTPHdrValue struct {
	...
	// HTTP header value or variable representing an HTTP header. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
