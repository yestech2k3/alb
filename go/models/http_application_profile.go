...
type HTTPApplicationProfile struct {
	...
	// Allow use of dot (.) in HTTP header names, for instance Header.app.special  PickAppVersionX. Allowed in Enterprise with any value edition, Essentials(Allowed values- false) edition, Basic(Allowed values- false) edition, Enterprise with Cloud Services edition.
	AllowDotsInHeaderName *bool `json:"allow_dots_in_header_name,omitempty"`

	// HTTP Caching config to use with this HTTP Profile. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	CacheConfig *HTTPCacheConfig `json:"cache_config,omitempty"`

	// The maximum length of time allowed between consecutive read operations for a client request body. The value '0' specifies no timeout. This setting generally impacts the length of time allowed for a client to send a POST. Allowed values are 0-100000000. Unit is MILLISECONDS. Allowed in Enterprise with any value edition, Essentials(Allowed values- 30000) edition, Basic(Allowed values- 30000) edition, Enterprise with Cloud Services edition.
	ClientBodyTimeout *int32 `json:"client_body_timeout,omitempty"`

	// The maximum length of time allowed for a client to transmit an entire request header. This helps mitigate various forms of SlowLoris attacks. Allowed values are 10-100000000. Unit is MILLISECONDS. Allowed in Enterprise with any value edition, Essentials(Allowed values- 10000) edition, Basic(Allowed values- 10000) edition, Enterprise with Cloud Services edition.
	ClientHeaderTimeout *int32 `json:"client_header_timeout,omitempty"`

	// Maximum size for the client request body.  This limits the size of the client data that can be uploaded/posted as part of a single HTTP Request.  Default 0 => Unlimited. Unit is KB. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	ClientMaxBodySize *int64 `json:"client_max_body_size,omitempty"`

	// Maximum size in Kbytes of a single HTTP header in the client request. Allowed values are 1-64. Unit is KB. Allowed in Enterprise with any value edition, Essentials(Allowed values- 12) edition, Basic(Allowed values- 12) edition, Enterprise with Cloud Services edition.
	ClientMaxHeaderSize *int32 `json:"client_max_header_size,omitempty"`

	// Maximum size in Kbytes of all the client HTTP request headers.This value can be overriden by client_max_header_size if that is larger. Allowed values are 1-256. Unit is KB. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	ClientMaxRequestSize *int32 `json:"client_max_request_size,omitempty"`

	// If enabled, the client's TLS fingerprint will be collected and included in the Application Log. Field introduced in 22.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	CollectClientTLSFingerprint *bool `json:"collect_client_tls_fingerprint,omitempty"`

	// HTTP Compression settings to use with this HTTP Profile. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Detect NTLM apps based on the HTTP Response from the server. Once detected, connection multiplexing will be disabled for that connection. Field introduced in 20.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Disable strict check between TLS servername and HTTP Host name. Field introduced in 18.2.5. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	DisableSniHostnameCheck *bool `json:"disable_sni_hostname_check,omitempty"`

	// Enable chunk body merge for chunked transfer encoding response. Field introduced in 18.2.7. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Enable request body buffering for POST requests. If enabled, max buffer size is set to lower of 32M or the value (non-zero) configured in client_max_body_size. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Number of days for which the client should regard this virtual service as a known HSTS host. Allowed values are 0-10000. Allowed in Enterprise with any value edition, Essentials(Allowed values- 365) edition, Basic(Allowed values- 365) edition, Enterprise with Cloud Services edition.
	...
	// Enable HTTP2 for traffic from clients to the virtual service. Field deprecated in 20.1.1. Field introduced in 18.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	Http2Enabled *bool `json:"http2_enabled,omitempty"`

	// Specifies the HTTP/2 specific application profile parameters. Field introduced in 18.2.10, 20.1.1. Allowed in Enterprise with any value edition, Basic edition, Enterprise with Cloud Services edition.
	Http2Profile *Http2ApplicationProfile `json:"http2_profile,omitempty"`

	// Client requests received via HTTP will be redirected to HTTPS. Allowed in Enterprise with any value edition, Essentials(Allowed values- false) edition, Basic edition, Enterprise with Cloud Services edition.
	HTTPToHTTPS *bool `json:"http_to_https,omitempty"`

	// Size of HTTP buffer in kB. Allowed values are 1-256. Special values are 0- Auto compute the size of buffer. Field introduced in 20.1.1. Unit is KB. Allowed in Enterprise with any value edition, Essentials(Allowed values- 0) edition, Basic(Allowed values- 0) edition, Enterprise with Cloud Services edition.
	...
	// The max idle time allowed between HTTP requests over a Keep-alive connection. Allowed values are 10-100000000. Unit is MILLISECONDS. Allowed in Enterprise with any value edition, Essentials(Allowed values- 30000) edition, Basic edition, Enterprise with Cloud Services edition.
	KeepaliveTimeout *int32 `json:"keepalive_timeout,omitempty"`

	// Maximum bad requests per second per client IP. Allowed values are 10-1000. Special values are 0- unlimited. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	MaxBadRpsCip *int32 `json:"max_bad_rps_cip,omitempty"`

	// Maximum bad requests per second per client IP and URI. Allowed values are 10-1000. Special values are 0- unlimited. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	MaxBadRpsCipURI *int32 `json:"max_bad_rps_cip_uri,omitempty"`

	// Maximum bad requests per second per URI. Allowed values are 10-1000. Special values are 0- unlimited. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	MaxBadRpsURI *int32 `json:"max_bad_rps_uri,omitempty"`

	// The max number of concurrent streams over a client side HTTP/2 connection. Allowed values are 1-256. Field deprecated in 18.2.10, 20.1.1. Field introduced in 18.2.6. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Maximum size in Kbytes of all the HTTP response headers. Allowed values are 1-256. Unit is KB. Allowed in Enterprise with any value edition, Essentials(Allowed values- 48) edition, Basic(Allowed values- 48) edition, Enterprise with Cloud Services edition.
	MaxResponseHeadersSize *int32 `json:"max_response_headers_size,omitempty"`

	// Maximum requests per second per client IP. Allowed values are 10-1000. Special values are 0- unlimited. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	MaxRpsCip *int32 `json:"max_rps_cip,omitempty"`

	// Maximum requests per second per client IP and URI. Allowed values are 10-1000. Special values are 0- unlimited. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	MaxRpsCipURI *int32 `json:"max_rps_cip_uri,omitempty"`

	// Maximum unknown client IPs per second. Allowed values are 10-1000. Special values are 0- unlimited. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	MaxRpsUnknownCip *int32 `json:"max_rps_unknown_cip,omitempty"`

	// Maximum unknown URIs per second. Allowed values are 10-1000. Special values are 0- unlimited. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	MaxRpsUnknownURI *int32 `json:"max_rps_unknown_uri,omitempty"`

	// Maximum requests per second per URI. Allowed values are 10-1000. Special values are 0- unlimited. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	MaxRpsURI *int32 `json:"max_rps_uri,omitempty"`

	// Pass through X-ACCEL headers. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	PassThroughXAccelHeaders *bool `json:"pass_through_x_accel_headers,omitempty"`

	// Select the PKI profile to be associated with the Virtual Service. This profile defines the Certificate Authority and Revocation List. It is a reference to an object of type PKIProfile. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// If enabled, an HTTP request on an SSL port will result in connection close instead of a 400 response. Field introduced in 18.2.6. Allowed in Enterprise with any value edition, Essentials(Allowed values- false) edition, Basic(Allowed values- false) edition, Enterprise with Cloud Services edition.
	ResetConnHTTPOnSslPort *bool `json:"reset_conn_http_on_ssl_port,omitempty"`

	// Avi will respond with 100-Continue response if Expect  100-Continue header received from client. Field introduced in 17.2.8. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// This field is deprecated. Field deprecated in 18.2.8. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	SpdyEnabled *bool `json:"spdy_enabled,omitempty"`

	// This field is deprecated. Field deprecated in 18.2.8. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	SpdyFwdProxyMode *bool `json:"spdy_fwd_proxy_mode,omitempty"`

	// Set of match/action rules that govern what happens when the client certificate request is enabled. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	SslClientCertificateAction *SSLClientCertificateAction `json:"ssl_client_certificate_action,omitempty"`

	// Specifies whether the client side verification is set to none, request or require. Enum options - SSL_CLIENT_CERTIFICATE_NONE, SSL_CLIENT_CERTIFICATE_REQUEST, SSL_CLIENT_CERTIFICATE_REQUIRE. Allowed in Enterprise with any value edition, Essentials(Allowed values- SSL_CLIENT_CERTIFICATE_NONE,SSL_CLIENT_CERTIFICATE_REQUIRE) edition, Basic(Allowed values- SSL_CLIENT_CERTIFICATE_NONE,SSL_CLIENT_CERTIFICATE_REQUIRE) edition, Enterprise with Cloud Services edition.
	SslClientCertificateMode *string `json:"ssl_client_certificate_mode,omitempty"`

	// Enable common settings to increase the level of security for  virtual services running HTTP and HTTPS. For sites that are  HTTP only, these settings will have no effect. Field deprecated in 18.2.7. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	SslEverywhereEnabled *bool `json:"ssl_everywhere_enabled,omitempty"`

	// Detect client IP from user specified header at the configured index in the specified direction. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	TrueClientIP *TrueClientIPConfig `json:"true_client_ip,omitempty"`

	// Use 'Keep-Alive' header timeout sent by application instead of sending the HTTP Keep-Alive Timeout. Allowed in Enterprise with any value edition, Essentials(Allowed values- false) edition, Basic(Allowed values- false) edition, Enterprise with Cloud Services edition.
	UseAppKeepaliveTimeout *bool `json:"use_app_keepalive_timeout,omitempty"`

	// Detect client IP from user specified header. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Provide a custom name for the X-Forwarded-For header sent to the servers. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
