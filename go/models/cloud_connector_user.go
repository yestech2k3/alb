...
type CloudConnectorUser struct {
	...
	// Credentials for Google Cloud Platform. Field introduced in 18.2.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Credentials to talk to NSX-T manager. Field introduced in 20.1.1. Allowed in Enterprise with any value edition, Basic edition, Enterprise with Cloud Services edition.
	NsxtCredentials *NsxtCredentials `json:"nsxt_credentials,omitempty"`

	// Credentials for Oracle Cloud Infrastructure. Field introduced in 18.2.1,18.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Credentials for Tencent Cloud. Field introduced in 18.2.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Credentials to talk to VCenter. Field introduced in 20.1.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
