...
type SeHmEventGSDetails struct {
	...
	// GslbService name. It is a reference to an object of type GslbService. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Reason Gslb Service is down. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
