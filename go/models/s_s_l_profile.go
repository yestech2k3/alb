...
type SSLProfile struct {
	...
	// Ciphers suites represented as defined by https //www.openssl.org/docs/apps/ciphers.html. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	AcceptedCiphers *string `json:"accepted_ciphers,omitempty"`

	// Set of versions accepted by the server. Minimum of 1 items required. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// DH Parameters used in SSL. At this time, it is not configurable and is set to 2048 bits. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	Dhparam *string `json:"dhparam,omitempty"`

	// Elliptic Curve Cryptography NamedCurves (TLS Supported Groups)represented as defined by RFC 8422-Section 5.1.1 andhttps //www.openssl.org/docs/man1.1.0/man3/SSL_CTX_set1_curves.html. Field introduced in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	EcNamedCurve *string `json:"ec_named_curve,omitempty"`

	// Enable early data processing for TLS1.3 connections. Field introduced in 18.2.6. Allowed in Enterprise with any value edition, Essentials(Allowed values- false) edition, Basic(Allowed values- false) edition, Enterprise with Cloud Services edition.
	EnableEarlyData *bool `json:"enable_early_data,omitempty"`

	// Enable SSL session re-use. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Prefer the SSL cipher ordering presented by the client during the SSL handshake over the one specified in the SSL Profile. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	PreferClientCipherOrdering *bool `json:"prefer_client_cipher_ordering,omitempty"`

	// Send 'close notify' alert message for a clean shutdown of the SSL connection. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	SendCloseNotify *bool `json:"send_close_notify,omitempty"`

	// Signature Algorithms represented as defined by RFC5246-Section 7.4.1.4.1 andhttps //www.openssl.org/docs/man1.1.0/man3/SSL_CTX_set1_client_sigalgs_list.html. Field introduced in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	SignatureAlgorithm *string `json:"signature_algorithm,omitempty"`

	//  Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	SslRating *SSLRating `json:"ssl_rating,omitempty"`

	// The amount of time in seconds before an SSL session expires. Unit is SEC. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// SSL Profile Type. Enum options - SSL_PROFILE_TYPE_APPLICATION, SSL_PROFILE_TYPE_SYSTEM. Field introduced in 17.2.8. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
