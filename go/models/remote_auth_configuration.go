...
type RemoteAuthConfiguration struct {
	...
	// UUID of the AuthMappingProfile(set of auth mapping rules) to assign to user on successful match. It is a reference to an object of type AuthMappingProfile. Field introduced in 22.1.1. Allowed in Enterprise edition with any value, Enterprise with Cloud Services edition.
	// Required: true
