...
type EventDetails struct {
	...
	// Adaptive replication event e.g. DNS VS, config version. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Details for Attach IP status. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	//  Field introduced in 17.2.10,18.1.2. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Azure marketplace license term acceptance event. Field introduced in 18.2.2. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// Central license refresh details. Field introduced in 21.1.4. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	CentralLicenseRefreshDetails *CentralLicenseRefreshDetails `json:"central_license_refresh_details,omitempty"`

	// Central license subscription details. Field introduced in 21.1.4. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Cloud Routes event. Field introduced in 20.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Connection event. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	//  Field introduced in 20.1.4. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Database error event. Field introduced in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Details for Detach IP status. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// False positive details. Field introduced in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// NSX-T ServiceInsertion VirtualEndpoint event. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	NsxtEndpointDetails *NsxtSIEndpointDetails `json:"nsxt_endpoint_details,omitempty"`

	// Nsxt Image event. Field introduced in 20.1.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	NsxtImgDetails *NsxtImageDetails `json:"nsxt_img_details,omitempty"`

	// Nsxt cloud event. Field introduced in 20.1.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	NsxtInfo *NsxtSetup `json:"nsxt_info,omitempty"`

	// NSX-T ServiceInsertion RedirectPolicy event. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	NsxtPolicyDetails *NsxtSIpolicyDetails `json:"nsxt_policy_details,omitempty"`

	// NSX-T ServiceInsertion RedirectRule event. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	NsxtRuleDetails *NsxtSIRuleDetails `json:"nsxt_rule_details,omitempty"`

	// NSX-T ServiceInsertion Service event. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Inter-SE datapath heartbeat recovered. One event is generated when heartbeat recovers. Field introduced in 20.1.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	SeHbRecoveredEventDetails *SeHbRecoveredEventDetails `json:"se_hb_recovered_event_details,omitempty"`

	//  Field introduced in 21.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	//  Field introduced in 18.2.2. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// VS Flows disrupted when a VS was deleted from SE. Field introduced in 22.1.1. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	//  Field introduced in 18.2.11,20.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Security-mgr UA Cache event details. Field introduced in 21.1.2. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Azure cloud sync services event details. Field introduced in 18.2.3. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	//  Field introduced in 18.2.6. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
	...
	// VCenter Cluster event. Field introduced in 20.1.7, 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Details for VIP Symmetry. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
	...
	// Details for Primary Switchover status. Field introduced in 21.1.3. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
