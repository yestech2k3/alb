...
type SCServerStateInfo struct {
	...
	//  Allowed values are 1-65535. Field introduced in 17.1.1. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
