...
type CdpLldpInfo struct {
	...
	//  Enum options - CDP, LLDP, NOT_APPLICABLE. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
