...
type SubResource struct {
	...
	// Allows modification of all fields except for the specified subresources. Field introduced in 20.1.5. Allowed in Enterprise with any value edition, Enterprise with Cloud Services edition.
