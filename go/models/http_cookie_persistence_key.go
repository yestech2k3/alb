...
type HTTPCookiePersistenceKey struct {
	...
	// name to use for cookie encryption. Allowed in Enterprise with any value edition, Essentials edition, Basic edition, Enterprise with Cloud Services edition.
